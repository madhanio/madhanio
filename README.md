...
| "just one more feature" loop |    "ship it now" mindset    |
|   coffee-driven development  |    tea-powered debugging    |
|      async/await thinker     | synchronous reality handler |
...
```javascript
const madhan = {
    location: "between ideation and execution",
    status: "compiling thoughts...",
    languages: ["Java", "Kotlin", "English", "Sarcasm"],
    currentMood: "🎯",
    sleepSchedule: "undefined",
    favoriteDebugMethod: "console.log('why is this happening')",
    workingOn: "building things that actually matter",
};
```
...
<img src="https://github-readme-stats.vercel.app/api/top-langs/?username=madhanio&layout=compact&theme=radical&hide_border=true&bg_color=0D1117&title_color=8B5CF6&text_color=C9D1D9&langs_count=6" width="49%" alt="Top Languages"/>
